...
const (
	Auth_GetAdminToken_FullMethodName   = "/openchat.auth.auth/getAdminToken"
	Auth_GetUserToken_FullMethodName    = "/openchat.auth.auth/getUserToken"
	Auth_ForceLogout_FullMethodName     = "/openchat.auth.auth/forceLogout"
	Auth_ParseToken_FullMethodName      = "/openchat.auth.auth/parseToken"
	Auth_InvalidateToken_FullMethodName = "/openchat.auth.auth/invalidateToken"
	Auth_KickTokens_FullMethodName      = "/openchat.auth.auth/kickTokens"
)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "openchat.auth.auth",
