...
const (
	User_GetDesignateUsers_FullMethodName             = "/openchat.user.user/getDesignateUsers"
	User_UpdateUserInfo_FullMethodName                = "/openchat.user.user/updateUserInfo"
	User_UpdateUserInfoEx_FullMethodName              = "/openchat.user.user/updateUserInfoEx"
	User_SetGlobalRecvMessageOpt_FullMethodName       = "/openchat.user.user/setGlobalRecvMessageOpt"
	User_GetGlobalRecvMessageOpt_FullMethodName       = "/openchat.user.user/getGlobalRecvMessageOpt"
	User_AccountCheck_FullMethodName                  = "/openchat.user.user/accountCheck"
	User_GetPaginationUsers_FullMethodName            = "/openchat.user.user/getPaginationUsers"
	User_UserRegister_FullMethodName                  = "/openchat.user.user/userRegister"
	User_GetAllUserID_FullMethodName                  = "/openchat.user.user/getAllUserID"
	User_UserRegisterCount_FullMethodName             = "/openchat.user.user/userRegisterCount"
	User_SubscribeOrCancelUsersStatus_FullMethodName  = "/openchat.user.user/subscribeOrCancelUsersStatus"
	User_GetSubscribeUsersStatus_FullMethodName       = "/openchat.user.user/getSubscribeUsersStatus"
	User_GetUserStatus_FullMethodName                 = "/openchat.user.user/getUserStatus"
	User_SetUserStatus_FullMethodName                 = "/openchat.user.user/setUserStatus"
	User_ProcessUserCommandAdd_FullMethodName         = "/openchat.user.user/processUserCommandAdd"
	User_ProcessUserCommandUpdate_FullMethodName      = "/openchat.user.user/processUserCommandUpdate"
	User_ProcessUserCommandDelete_FullMethodName      = "/openchat.user.user/processUserCommandDelete"
	User_ProcessUserCommandGet_FullMethodName         = "/openchat.user.user/processUserCommandGet"
	User_ProcessUserCommandGetAll_FullMethodName      = "/openchat.user.user/processUserCommandGetAll"
	User_AddNotificationAccount_FullMethodName        = "/openchat.user.user/addNotificationAccount"
	User_UpdateNotificationAccountInfo_FullMethodName = "/openchat.user.user/updateNotificationAccountInfo"
	User_SearchNotificationAccount_FullMethodName     = "/openchat.user.user/searchNotificationAccount"
	User_GetNotificationAccount_FullMethodName        = "/openchat.user.user/getNotificationAccount"
	User_SortQuery_FullMethodName                     = "/openchat.user.user/sortQuery"
	User_SetUserOnlineStatus_FullMethodName           = "/openchat.user.user/setUserOnlineStatus"
	User_GetAllOnlineUsers_FullMethodName             = "/openchat.user.user/getAllOnlineUsers"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "openchat.user.user",
