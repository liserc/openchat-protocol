...
const (
	Conversation_GetConversation_FullMethodName                         = "/openchat.conversation.conversation/GetConversation"
	Conversation_GetSortedConversationList_FullMethodName               = "/openchat.conversation.conversation/GetSortedConversationList"
	Conversation_GetAllConversations_FullMethodName                     = "/openchat.conversation.conversation/GetAllConversations"
	Conversation_GetConversations_FullMethodName                        = "/openchat.conversation.conversation/GetConversations"
	Conversation_SetConversation_FullMethodName                         = "/openchat.conversation.conversation/SetConversation"
	Conversation_GetRecvMsgNotNotifyUserIDs_FullMethodName              = "/openchat.conversation.conversation/GetRecvMsgNotNotifyUserIDs"
	Conversation_CreateSingleChatConversations_FullMethodName           = "/openchat.conversation.conversation/CreateSingleChatConversations"
	Conversation_CreateGroupChatConversations_FullMethodName            = "/openchat.conversation.conversation/CreateGroupChatConversations"
	Conversation_SetConversationMaxSeq_FullMethodName                   = "/openchat.conversation.conversation/SetConversationMaxSeq"
	Conversation_SetConversationMinSeq_FullMethodName                   = "/openchat.conversation.conversation/SetConversationMinSeq"
	Conversation_GetConversationIDs_FullMethodName                      = "/openchat.conversation.conversation/GetConversationIDs"
	Conversation_SetConversations_FullMethodName                        = "/openchat.conversation.conversation/SetConversations"
	Conversation_GetUserConversationIDsHash_FullMethodName              = "/openchat.conversation.conversation/GetUserConversationIDsHash"
	Conversation_GetConversationsByConversationID_FullMethodName        = "/openchat.conversation.conversation/GetConversationsByConversationID"
	Conversation_GetConversationOfflinePushUserIDs_FullMethodName       = "/openchat.conversation.conversation/GetConversationOfflinePushUserIDs"
	Conversation_GetConversationNotReceiveMessageUserIDs_FullMethodName = "/openchat.conversation.conversation/GetConversationNotReceiveMessageUserIDs"
	Conversation_UpdateConversation_FullMethodName                      = "/openchat.conversation.conversation/UpdateConversation"
	Conversation_GetFullOwnerConversationIDs_FullMethodName             = "/openchat.conversation.conversation/GetFullOwnerConversationIDs"
	Conversation_GetIncrementalConversation_FullMethodName              = "/openchat.conversation.conversation/GetIncrementalConversation"
	Conversation_GetOwnerConversation_FullMethodName                    = "/openchat.conversation.conversation/GetOwnerConversation"
	Conversation_GetConversationsNeedDestructMsgs_FullMethodName        = "/openchat.conversation.conversation/GetConversationsNeedDestructMsgs"
	Conversation_GetNotNotifyConversationIDs_FullMethodName             = "/openchat.conversation.conversation/GetNotNotifyConversationIDs"
	Conversation_GetPinnedConversationIDs_FullMethodName                = "/openchat.conversation.conversation/GetPinnedConversationIDs"
)
...
// UnimplementedConversationServer should be embedded to have
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "openchat.conversation.conversation",
